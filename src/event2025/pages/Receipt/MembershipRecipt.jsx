...
import Receiptmember from "../../components/ReceiptComponent/Receiptmember";

const MembershipRecipt = () => {
    ...
    <div className="my-10">
      {loading || !renderReady ? (
        ...
        <div className="flex flex-col justify-center">
          ...
          <div ref={receiptRef}>
            <Receiptmember data={receiptData} />
          </div>
        </div>
      ) : (
...
export default MembershipRecipt;
